        ...
        <div className="job-wall-all">
          <Container className="max-w-screen-lg">
            <div className="title-job-wall flex flex-col text-center ">
              <p className="text-2xl md:text-4xl mt-8 text-center">
                東京都の求人
              </p>
              <div className="text-base md:text-3xl flex ">
                <button className="title-job-wall-a pt-6 h-full w-full" href="#">
                  おすすめ順
                </button>
                <button className="title-job-wall-a pt-6 h-full w-full" href="#">
                  新着順
            ...
            <JobWal
              content1="保育士(認可保育園/託児所)/資格必須/ブランクあり"
              content2="東京都東久留米市"
              image="https://picsum.photos/440/220"
            />
            <JobWal
              content1="保育士(認可保育園/託児所)/資格必須/ブランクあり"
              content2="東京都東久留米市"
